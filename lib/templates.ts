...
// ─────────────────────────────────────────────────────────────────────────────
// PLANTILLAS ADICIONALES (tipos del sitemap que no estaban cubiertos)
// ─────────────────────────────────────────────────────────────────────────────

// ── Eliminación de antecedentes penales ──
TEMPLATES.push({
  id: 'eliminacion-antecedentes-penales',
  keywords: ['eliminacion antecedentes', 'eliminar antecedentes', 'borrar antecedentes', 'prontuario'],
  titulo: 'Solicitud de eliminación de antecedentes penales',
  tipo: 'solicitud',
  articulos: [
    'Art. 22 de la Ley 18.575 (eliminación de anotaciones prontuariales)',
    'D.S. N° 64 de 1994 del Ministerio de Justicia (Reglamento del Sistema de Prontuario)',
  ],
  esqueleto: `[CIUDAD], [FECHA]
...
Que, con fecha [[FECHA DE LA CONDENA]], el suscrito fue condenado por [[DELITO]] ante el Juzgado de Garantía de [[TRIBUNAL]], causa RIT [[RIT]], condena que se encuentra cumplida en su totalidad.

II. FUNDAMENTO LEGAL

El artículo 22 de la Ley 18.575 establece el derecho a solicitar la eliminación de antecedentes una vez cumplida la condena.

III. PETICIÓN

POR TANTO,
RUEGO A US.: Ordenar la eliminación de las anotaciones prontuariales del suscrito.`,
  instruccion_llm: 'Solicitud judicial. Formato escrito con PRESENTE, secciones y POR TANTO. No inventes delitos ni fechas.',
});

// ── Limpieza de hoja de vida del conductor ──
TEMPLATES.push({
  id: 'limpieza-hoja-vida-conductor',
  keywords: ['limpieza hoja vida conductor', 'limpiar hoja vida', 'registro conductor', 'multas conductor'],
  titulo: 'Solicitud de limpieza de hoja de vida del conductor',
  tipo: 'solicitud',
  articulos: [
    'Art. 20 de la Ley 18.290 (Ley de Tránsito, registro de multas)',
...
Que, el suscrito registra infracciones de tránsito que se encuentran prescritas: [[DETALLAR MULTAS]].

II. DERECHO

Conforme al artículo 20 de la Ley 18.290 y normas concordantes, solicito la eliminación de dichas anotaciones.

III. PETICIÓN

POR TANTO,
RUEGO A US.: Ordenar la eliminación de las anotaciones en la hoja de vida del conductor del suscrito.`,
  instruccion_llm: 'Solicitud judicial ante JPL. Formato judicial con PRESENTE y POR TANTO.',
});

// ── Omisión de antecedentes VIF ──
TEMPLATES.push({
  id: 'omision-antecedentes-violencia-intrafamiliar',
  keywords: ['omision antecedentes vif', 'violencia intrafamiliar', 'borrar antecedentes vif'],
  titulo: 'Solicitud de omisión de antecedentes por violencia intrafamiliar',
  tipo: 'solicitud',
  articulos: [
    'Art. 12 de la Ley 20.066 (Ley de Violencia Intrafamiliar)',
    'Art. 21 del D.S. N° 64 del Ministerio de Justicia (Prontuario)',
  ],
  esqueleto: `[CIUDAD], [FECHA]
...
Que, con fecha [[FECHA]] se dictó sentencia en causa RIT [[RIT]] por violencia intrafamiliar, condena cumplida a la fecha.

II. FUNDAMENTO LEGAL

El artículo 12 de la Ley 20.066 establece que, cumplida la condena, se puede solicitar la omisión de estos antecedentes.

III. PETICIÓN

POR TANTO,
RUEGO A US.: Ordenar la omisión de los antecedentes del suscrito.`,
...
TEMPLATES.push({
  ...
  keywords: ['registro deudores pensiones', 'deudor alimentos', 'pension alimenticia', 'moroso pension'],
  ...
  articulos: [
    ...
    'Art. 14 de la Ley 14.908 (Pensión de Alimentos)',
  ],
  esqueleto: `[CIUDAD], [FECHA]
...
Que, en causa RIT [[RIT]] sobre alimentos, el demandado [[NOMBRE DEMANDADO]] adeuda [[MONTO ADEUDADO]] por pensión de alimentos.
...
RUEGO A US.: Ordenar la inscripción del demandado en el Registro Nacional de Deudores de Pensiones de Alimentos, conforme a la Ley 21.389.`,
  instruccion_llm: 'Solicitud judicial. Formato escrito. Datos: RIT, nombre demandado, monto.',
});

// ── Acuerdo de confidencialidad (NDA) ──
TEMPLATES.push({
  id: 'acuerdo-confidencialidad',
  keywords: ['acuerdo confidencialidad', 'nda', 'confidencial', 'no divulgacion'],
  titulo: 'Acuerdo de Confidencialidad (NDA)',
  tipo: 'contrato',
  articulos: [
    'Art. 1545 del Código Civil (buena fe contractual)',
    'Art. 1560 del Código Civil (interpretación contractual)',
  ],
  esqueleto: `ACUERDO DE CONFIDENCIALIDAD

En [CIUDAD], a [FECHA], comparecen: [[PARTE_REVELADORA]] y [[PARTE_RECEPTORA]].

PRIMERO: OBJETO. La Parte Reveladora divulgará información confidencial relativa a [[DESCRIBIR INFORMACIÓN]].

SEGUNDO: OBLIGACIONES. La Parte Receptora se obliga a no divulgar ni usar la información para fines distintos.

TERCERO: PLAZO. La obligación de confidencialidad regirá por [[PLAZO]] años.
...
TEMPLATES.push({
  ...
  keywords: ['acuerdo pago', 'pago deuda', 'reprogramar deuda', 'convenio pago'],
  titulo: 'Acuerdo de pago de deuda',
  tipo: 'contrato',
  articulos: [
    'Art. 1551 del Código Civil (mora)',
    'Art. 1567 del Código Civil (modos de extinguir obligaciones)',
  ],
  esqueleto: `ACUERDO DE PAGO

En [CIUDAD], a [FECHA], comparecen: [[ACREEDOR]], RUT [[RUT_ACREEDOR]], y [[DEUDOR]], RUT [[RUT_DEUDOR]].

PRIMERO: RECONOCIMIENTO. El Deudor reconoce adeudar [[MONTO TOTAL]].

SEGUNDO: FORMA DE PAGO. El Deudor pagará en [[NÚMERO DE CUOTAS]] cuotas de [[MONTO CUOTA]].

TERCERO: MORA. El incumplimiento de [[NÚMERO DE CUOTAS]] cuotas faculta al Acreedor a exigir el total.

CUARTO: Las partes firman.`,
  instruccion_llm: 'Acuerdo bilateral (contrato). NO judicial.',
});

// ── Acuerdo de divorcio de mutuo acuerdo ──
TEMPLATES.push({
  id: 'acuerdo-divorcio-mutuo-acuerdo',
  keywords: ['divorcio mutuo acuerdo', 'divorcio', 'cese convivencia'],
  titulo: 'Acuerdo de divorcio de mutuo acuerdo',
  tipo: 'contrato',
  articulos: [
    'Art. 21 de la Ley 19.947 (Ley de Matrimonio Civil, divorcio de mutuo acuerdo)',
    'Art. 22 de la Ley 19.947 (acuerdo regulador)',
  ],
  esqueleto: `ACUERDO DE DIVORCIO DE MUTUO ACUERDO

En [CIUDAD], a [FECHA], comparecen: [[CÓNYUGE 1]] y [[CÓNYUGE 2]].

PRIMERO: CESACIÓN DE CONVIVENCIA. Las partes cesaron su convivencia con fecha [[FECHA CESE]].

SEGUNDO: HIJOS. [[DETALLE HIJOS Y RÉGIMEN]].

TERCERO: BIENES. [[RÉGIMEN DE BIENES]].

CUARTO: Las partes solicitan al tribunal la aprobación del presente acuerdo.`,
  instruccion_llm: 'Acuerdo bilateral. NO judicial. Formato de acuerdo con clausulas.',
});

// ── Acuerdo de tuición compartida ──
TEMPLATES.push({
  id: 'acuerdo-tuicion-compartida',
  keywords: ['tuicion compartida', 'cuidado personal', 'hijos', 'tenencia compartida'],
  titulo: 'Acuerdo de cuidado personal compartido',
  tipo: 'contrato',
  articulos: [
    'Art. 224 del Código Civil (cuidado personal de los hijos)',
    'Art. 225 del Código Civil (acuerdo de cuidado personal)',
  ],
  esqueleto: `ACUERDO DE CUIDADO PERSONAL COMPARTIDO

En [CIUDAD], a [FECHA], comparecen: [[PADRE/MADRE 1]] y [[PADRE/MADRE 2]], padres de [[NOMBRE HIJOS]].

PRIMERO: Ambos padres ejercerán el cuidado personal compartido de [[NOMBRE HIJO(S)]].

SEGUNDO: El hijo permanecerá [[DÍAS CON CADA UNO]].
...
TEMPLATES.push({
  id: 'certificado-antecedentes-fines-especiales',
  keywords: ['certificado antecedentes fines especiales', 'certificado antecedentes', 'solicitar antecedentes'],
  titulo: 'Solicitud de certificado de antecedentes para fines especiales',
  tipo: 'solicitud',
  articulos: [
    'Ley 19.628 (Ley de Datos Personales)',
    'Art. 12 de la Constitución Política de la República',
  ],
  esqueleto: `SOLICITUD DE CERTIFICADO DE ANTECEDENTES

[NOMBRE], RUT [RUT], domiciliado en [DIRECCIÓN], solicita la emisión de un certificado de antecedentes para fines especiales.

El presente certificado tiene por objeto [[FINALIDAD]].

[NOMBRE]
RUT: [RUT]`,
  instruccion_llm: 'Solicitud simple, no judicial.',
});
