...
export const TEMPLATES: LegalTemplate[] = [
  ...
  {
    id: 'cese-pension-alimentos',
    keywords: ['cese', 'cesar', 'termino', 'pension', 'alimentos', 'alimenticia', 'cesar pension'],
    titulo: 'Demanda de Cese de Pensión Alimenticia',
    tipo: 'judicial',
    entidad: 'Juzgado de Familia',
    articulos: ['Art. 332 Código Civil (cese de alimentos)', 'Art. 329 Código Civil (proporcionalidad según facultades del deudor)', 'Art. 18 Ley N° 14.908 (cese por cesantía del alimentante)', 'Ley 14.908 sobre Abandono de Familia y Pago de Pensiones Alimenticias'],
    esqueleto: `[CIUDAD], [FECHA_REAL]

EN LO PRINCIPAL: Demanda de cese de pensión alimenticia. PRIMER OTROSÍ: Acompaña documentos.

SEÑOR(A) JUEZ(A) DEL JUZGADO DE FAMILIA DE [[TRIBUNAL / JUZGADO DONDE SE TRAMITA LA CAUSA]]
PRESENTE

[NOMBRE EN MAYÚSCULAS], RUT [RUT], domiciliado en [DIRECCION], en los autos RIT [[RIT O ROL]], a US. respetuosamente digo:

I. ANTECEDENTES DE HECHO

Por resolución de este Tribunal, se me condenó a pagar una pensión alimenticia a favor de [[NOMBRE DEL DEMANDADO (QUIEN RECIBE LA PENSIÓN)]], RUT [[RUT DEL DEMANDADO]].

Sin embargo, en la actualidad han variado sustancialmente las circunstancias que se tuvieron a la vista para fijar dicha pensión, toda vez que:

[[DESCRIBIR EL MOTIVO DEL CESE: ej. el alimentario cumplió 28 años, o terminó sus estudios, o el demandante se encuentra cesante y sin ingresos, etc.]]

II. FUNDAMENTO LEGAL

El artículo 332 del Código Civil establece que los alimentos se entienden concedidos para toda la vida del alimentario, continuando las circunstancias que legitimaron la demanda. De la misma disposición se colige inequívocamente que los alimentos cesan si cesa o varía sustancialmente la causa que motivó su otorgamiento, lo cual es concordante con la regla del artículo 329 del mismo cuerpo legal, que ordena tener siempre en consideración las facultades del deudor y sus circunstancias.

En el caso de marras, al haber variado de forma permanente y sustancial las condiciones económicas o necesidades de las partes, resulta improcedente mantener vigente la carga alimenticia impuesta al suscrito.

III. PETICIÓN

POR TANTO, en mérito de lo expuesto y lo dispuesto en el artículo 332 del Código Civil y normas pertinentes de la Ley N° 14.908 y la Ley N° 19.968,

RUEGO A US.: Tener por interpuesta demanda de cese de pensión alimenticia en contra de [[NOMBRE DEL DEMANDADO]], ya individualizado, admitirla a tramitación, y en definitiva hacer lugar a ella, decretando el cese definitivo de la pensión alimenticia fijada en autos.

PRIMER OTROSÍ: Acompaño los siguientes documentos para acreditar lo expuesto:
[[LISTAR DOCUMENTOS SI LOS HAY: Ej: Finiquito, certificado de cesantía, certificado de nacimiento del hijo, etc.]]

[NOMBRE]
RUT: [RUT]`,
    instruccion_llm: 'Redacta demanda de cese de pensión alimenticia. OBLIGATORIO: Mencionar el RIT/ROL de la causa original y el tribunal competente. Fundamentar en el Art. 332 del Código Civil. Relacionar los hechos del demandante (ej: cesantía, edad del hijo) con la variación de circunstancias que exige la ley para cesar los alimentos. Reemplazar todos los marcadores [[ ]] con los datos del caso.',
  },
...
[NOMBRE EN MAYÚSCULAS], RUT [RUT], domiciliado en [DIRECCION], propietario inscrito del vehículo patente [[PATENTE]], a US. respetuosamente digo:
...
[NOMBRE EN MAYÚSCULAS], RUT [RUT], domiciliado en [DIRECCION], me dirijo a Ud. para hacer valer la prescripción extintiva de la deuda que me atribuye.
...
[NOMBRE EN MAYÚSCULAS], RUT [RUT], domiciliado en [DIRECCION], en calidad de consumidor, interpone el presente reclamo en virtud de la Ley N° 19.496 sobre Protección de los Derechos de los Consumidores.
...
En [CIUDAD], a [FECHA_REAL], comparecen: por una parte [DESTINATARIO], en adelante "el empleador"; y por la otra, [NOMBRE EN MAYÚSCULAS], cédula de identidad N° [RUT], domiciliado en [DIRECCION], en adelante "el trabajador". Ambas partes dejan constancia del término de la relación laboral y se otorgan el más amplio finiquito en los siguientes términos:
...
[NOMBRE EN MAYÚSCULAS], RUT [RUT], domiciliado en [DIRECCION], en los autos sobre pensión de alimentos seguidos en este Tribunal, a US. respetuosamente digo:
...
Yo, [NOMBRE EN MAYÚSCULAS], RUT [RUT], domiciliado en [DIRECCION], por medio del presente instrumento otorgo poder especial a:
...
[NOMBRE EN MAYÚSCULAS], RUT [RUT], domiciliado en [DIRECCION], en los autos sobre infracción de tránsito Rol N° [[ROL]], a US. respetuosamente digo:
...
[NOMBRE EN MAYÚSCULAS], RUT [RUT], domiciliado en [DIRECCION], deduce recurso de protección en contra de [[RECURRIDO: institución o persona que realiza el acto]], con domicilio en [[DIRECCIÓN DEL RECURRIDO]], por los hechos que a continuación se exponen.
...
[NOMBRE EN MAYÚSCULAS], RUT [RUT], cliente N° [[NÚMERO DE CLIENTE SI LO TIENE]], domiciliado en [DIRECCION], interpone reclamo formal en contra de esa empresa.
...
[NOMBRE EN MAYÚSCULAS], RUT [RUT], domiciliado en [DIRECCION], a US. respetuosamente digo:
...
[NOMBRE EN MAYÚSCULAS], RUT [RUT], domiciliado en [DIRECCION], correo electrónico [[EMAIL]], en virtud de lo dispuesto en la Ley N° 20.285 sobre Acceso a la Información Pública, solicita la siguiente información:
...
El despido comunicado con fecha [[FECHA_REAL]] es NULO por cuanto el empleador no se encontraba al dia en el pago de cotizaciones previsionales al momento de despedir, conforme al Art. 162 inc. 5 del Codigo del Trabajo.
...
[NOMBRE EN MAYÚSCULAS], RUT [RUT], domiciliado en [DIRECCION], en los autos sobre juicio ejecutivo [[CARÁTULA Y/O ROL DE LA CAUSA, si se conoce]], a US. respetuosamente digo:
...
Yo, [NOMBRE EN MAYÚSCULAS], cédula nacional de identidad N° [RUT], domiciliado en [DIRECCION], bajo juramento declaro lo siguiente:
...
export function findTemplate(materia: string | null, hechos: string | null): LegalTemplate | null {
  ...
  if (materia) {
    const exactMatch = TEMPLATES.find(t => t.id === materia);
    if (exactMatch) return exactMatch;
  }

  const matText = norm(materia ?? '');           // tipo de documento = señal mas fuerte
  const hechosText = norm(hechos ?? '');
  // Reemplazar guiones por espacios para que matcheen las keywords
  const fullText = `${matText} ${hechosText}`.replace(/-/g, ' ').trim();
