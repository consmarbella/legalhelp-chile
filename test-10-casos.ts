...
const CASOS: TestCase[] = [
  // 1. Finiquito estándar
  {
    ...
    mensajes: [
      ...
      'Trabajé en Supermercado Líder, cargo: cajera, sueldo $450.000, desde marzo 2021 hasta mayo 2026'
    ],
    expectReady: true,
  ...
  // 3. Reclamo SERNAC por producto defectuoso
  {
    ...
    mensajes: [
      ...
      'Compré un refrigerador marca Samsung el 15 de marzo de 2026, modelo RT38K5, por $450.000. A los 20 días dejó de enfriar. Llamé 5 veces al servicio técnico y nadie vino. Quiero devolución del dinero'
    ],
    expectReady: true,
  ...
  // 4. Despido injustificado con cotizaciones impagas
  {
    ...
    mensajes: [
      ...
      'Jorge Luis Cáceres Díaz, RUT 17.456.789-0',
  ...
  // 5. Prescripción de multa TAG
  {
    ...
    mensajes: [
      ...
      'Andrea Belén Fuentes Mora, RUT 19.123.456-7',
      'Patente BBXY12, las multas son de agosto 2019 por pasar sin TAG en Costanera Norte'
    ],
    expectReady: true,
  ...
  // 6. Demanda de alimentos
  {
    ...
    mensajes: [
      ...
      'Carolina Paz Vásquez Torres, RUT 16.890.123-4',
  ...
  // 7. Recurso de protección por corte de luz
  {
    ...
    mensajes: [
      ...
      'Enel me cortó el 20 de junio, llamé 3 veces y me dicen que fue error del sistema pero no reconectan. Mi hijo Tomás tiene fibrosis pulmonar y usa oxígeno 24/7. Vivo en Villa Los Almendros 78, Puente Alto'
    ],
    expectReady: true,
  ...
  // 10. Reclamo por servicio de internet deficiente
  {
    ...
    mensajes: [
      ...
      'Daniel Esteban Morales Castro, RUT 16.678.901-2',
      'Contraté el plan el 1 de abril 2026, número de cliente 12345678. Me dijeron "hasta 400 megas" pero en las mediciones sale 15-25 megas. Llamé 6 veces al 600, hicieron 2 visitas técnicas pero sigue igual. Quiero rebaja del 50% de la cuenta o cambio de plan sin costo'
    ],
    expectReady: true,
    expectDatos: ['nombre', 'rut', 'empresa', 'detalle_caso']
  }
