    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="px-6 py-5" style={{ fontFamily: 'sans-serif' }}>
          ...
          {onTestPayment && (
            <div className="w-full mb-3 text-center text-xs font-medium text-[#0b1f3a] bg-[#fff7e0] border border-dashed border-[#c9a84c] rounded-lg py-2 flex items-center justify-center gap-2">
              ...
              <input 
                ...
                placeholder="****"
                className="w-16 bg-white border border-[#c9a84c] rounded text-center px-1 py-0.5 outline-none"
              />
            </div>
          )}
